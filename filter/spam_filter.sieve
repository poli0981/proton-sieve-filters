#Sieve filter for spam messages
# Script: filter/spam_filter.sieve
# This script filters out spam messages based on specific subject lines.
require ["fileinto", "imap4flags", "reject", "discard"];
...
# Filter spam messages (only if not matched above)
    ...
    header :contains "subject" ["earn extra cash", "earn money", "get rich quick"],
    ...
    header :contains "subject" ["opt-in", "order", "order shipped by"],
    ...
    header :contains "subject" ["will not believe your eyes", "work at home"],
